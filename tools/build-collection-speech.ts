...
import {questionSpeechTexts} from "../platform/apps/web/lib/study/questions";
import {familySpeechTexts} from "../platform/apps/web/lib/study/people-family";
import {verbTeachingSpeech} from "../platform/apps/web/lib/study/verb-learning";
import {questionReplySpeech} from "../platform/apps/web/lib/study/question-learning";
import {numberTeachingSpeech} from "../platform/apps/web/lib/study/number-learning";
import {conversationTeachingSpeech} from "../platform/apps/web/lib/study/conversation-learning";
import {objectTeachingSpeech,officePhoneSpeech} from "../platform/apps/web/lib/study/object-learning";
import {timeTeachingSpeech} from "../platform/apps/web/lib/study/time-learning";
...
for(const text of questionSpeechTexts())if(!texts.includes(text))texts.push(text);
for(const text of familySpeechTexts)if(!texts.includes(text))texts.push(text);
for(const text of [...verbTeachingSpeech,...questionReplySpeech,...numberTeachingSpeech,...conversationTeachingSpeech,...objectTeachingSpeech,...officePhoneSpeech,...timeTeachingSpeech])if(!texts.includes(text))texts.push(text);
