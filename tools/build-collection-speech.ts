...
for(const text of [...verbTeachingSpeech,...questionReplySpeech,...numberTeachingSpeech,...conversationTeachingSpeech,...objectTeachingSpeech,...officePhoneSpeech])if(!texts.includes(text))texts.push(text);
