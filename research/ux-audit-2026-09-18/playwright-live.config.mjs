...
export default defineConfig({
  ...
  testMatch:['40-ux-readability.spec.ts','41-complete-backup.spec.ts','42-shared-learning-actions.spec.ts','43-navigation-and-continue.spec.ts','44-professions-learning.spec.ts','45-lessons-and-libraries.spec.ts','46-cheat-sheet-summaries.spec.ts','47-sheet-selection.spec.ts','48-people-learning.spec.ts'],
