...
const name=({5:'five',6:'six',7:'seven',8:'eight',9:'nine',10:'ten'})[lesson];
if(!name)throw Error('Choose an integrated lesson: 5, 6, 7, 8, 9 or 10');
