...
export type StudyUnit={
  ...
  verbs:{verb:string;meaning:string;forms:string[];tip:string;source?:string;priority?:string;participle?:string;auxiliary?:string;pastGroup?:string;preterite?:string[]}[];
