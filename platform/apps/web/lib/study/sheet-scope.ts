...
export const sheetTags:Record<SheetId,StudyTags>={
  ...
  verbs:{lessons:[1,2,3,4,5,6,7,8],concepts:["verbs","grammar","questions"],source:"course"},
  numbers:{lessons:[1,2,3,4,5,6,7,8],concepts:["numbers"],source:"course"},
  conversation:{lessons:[1,2,3,4,5,6,7,8],concepts:["conversation","introductions","classroom"],source:"course"},
  questions:{lessons:[1,2,3,4,5,6,7,8],concepts:["questions","grammar"],source:"course",sources:["course","study-extra"]},
