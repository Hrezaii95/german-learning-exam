...
import {loadCollectionSpeech,loadStudySpeech} from "./catalog";
...
export function SheetPage({sheet}:{sheet:ExtendedSheetId}){
  return <ShellLayout current="cheat-sheets"><CollectionCheatSheet sheet={sheet} cards={cardsForSheet(loadWordCards().cards,sheet)} speech={{...loadStudySpeech(),...loadCollectionSpeech()}}/></ShellLayout>;
}
