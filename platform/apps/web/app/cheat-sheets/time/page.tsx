...
export default function Page(){return <ShellLayout current="cheat-sheets"><TimeCheatSheet cards={loadWordCards().cards.filter(c=>c.studyTags?.lessons.includes(8))} speech={{...loadCollectionSpeech(),...loadStudySpeech()}}/></ShellLayout>;}
