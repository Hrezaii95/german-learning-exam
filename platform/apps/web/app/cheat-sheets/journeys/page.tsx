...
export default function Page(){return <ShellLayout current="cheat-sheets"><JourneyCheatSheet cards={loadWordCards().cards.filter(c=>c.studyTags?.lessons.includes(12))} speech={loadStudySpeech()}/></ShellLayout>;}
