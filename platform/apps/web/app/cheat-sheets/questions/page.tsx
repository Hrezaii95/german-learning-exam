...
import {loadCollectionSpeech,loadStudySpeech} from "@/lib/study/catalog";
...
export default function Page(){return <ShellLayout current="cheat-sheets"><QuestionCheatSheet speech={{...loadStudySpeech(),...loadCollectionSpeech()}}/></ShellLayout>;}
