...
export default function Page(){return <ShellLayout current="cheat-sheets"><FoodCheatSheet cards={loadWordCards().cards.filter(c=>c.studyTags?.lessons.includes(9))} speech={loadStudySpeech()}/></ShellLayout>;}
