...
export default function Page(){return <ShellLayout current="cheat-sheets"><HobbiesCheatSheet cards={loadWordCards().cards.filter(c=>c.studyTags?.lessons.includes(7))} speech={{...loadCollectionSpeech(),...loadStudySpeech()}}/></ShellLayout>;}
