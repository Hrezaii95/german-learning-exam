...
export default function Page(){return <ShellLayout current="cheat-sheets"><PastCheatSheet cards={loadWordCards().cards.filter(c=>c.studyTags?.lessons.includes(11))} speech={{...loadCollectionSpeech(),...loadStudySpeech()}}/></ShellLayout>;}
