...
export default function Page(){return <ShellLayout current="cheat-sheets"><ObjectCheatSheet cards={loadWordCards().cards.filter(c=>c.studyTags?.lessons.includes(5))} speech={{...loadCollectionSpeech(),...loadStudySpeech()}} unit={studyUnits.find(u=>u.number===5)!}/></ShellLayout>;}
