...
export default function Page(){return <ShellLayout current="cheat-sheets"><TravelCheatSheet cards={loadWordCards().cards.filter(c=>c.studyTags?.lessons.includes(10))} speech={{...loadCollectionSpeech(),...loadStudySpeech()}}/></ShellLayout>;}
