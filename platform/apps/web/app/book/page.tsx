...
export const metadata = { title: "Interactive book", description: "Read Momente Lessons 1–12 with original audio, word lookup and your personal review collection." };
