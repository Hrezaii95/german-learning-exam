...
import type { BookLine, BookManifest, BookTrack } from "@/lib/study/types";
...
function OriginalTrack({ track, rate }: { track: BookTrack; rate: number }) {
  ...
  return (
    <div className="book-track">
      ...
      {/* The original printed exercise appears beside the recording. */}
...
export function BookReader({
  ...
  const [view, setView] = useState<"read" | "page" | "split">("split");
        ...
        {view !== "read" && (
          ...
          >
            ...
            <div className="book-page-scroll">
              <div className="book-paper" style={{ width: `${zoom}%` }}>
                <img
                  key={page.image}
            ...
            <p className="book-page-caption">
              © Hueber Verlag · Tap a line on the page to study it.
            </p>
          </section>
        )}
        <section className="book-text-panel" aria-label="Page study tools">
          {tracks.length > 0 && (
