...
export function CourseListening({book}:{book:BookManifest}){
  ...
  const [query,setQuery]=useState(params.get("q")??""),[kind,setKind]=useState("all"),[rate,setRate]=useState(1);
